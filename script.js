document.addEventListener("DOMContentLoaded", () => {
 ...
 const dadosDoencas = {
   ...
   daltonismo: {
     ...
     sintomas: [
       "Dificuldade de distinguir cores como vermelho, verde, azul e amarelo",
       "Percepção de cores em tons mais opacos e desbotados",
       "Dificuldade em interpretar gráficos, mapas ou combinar roupas",
       "Visão apenas em preto, branco e cinza (em casos raros de acromatopsia)"
     ],
